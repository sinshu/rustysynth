...
impl InstrumentRegion
{
    ...
    {
        32768 * self.gs[GeneratorType::START_ADDRESS_COARSE_OFFSET as usize] as i32 + self.gs[GeneratorType::START_ADDRESS_OFFSET as usize] as i32
    }

    pub fn get_end_address_offset(&self) -> i32
    {
        32768 * self.gs[GeneratorType::END_ADDRESS_COARSE_OFFSET as usize] as i32 + self.gs[GeneratorType::END_ADDRESS_OFFSET as usize] as i32
    }

    pub fn get_start_loop_address_offset(&self) -> i32
    {
        32768 * self.gs[GeneratorType::START_LOOP_ADDRESS_COARSE_OFFSET as usize] as i32 + self.gs[GeneratorType::START_LOOP_ADDRESS_OFFSET as usize] as i32
    }

    pub fn get_end_loop_address_offset(&self) -> i32
    {
        32768 * self.gs[GeneratorType::END_LOOP_ADDRESS_COARSE_OFFSET as usize] as i32 + self.gs[GeneratorType::END_LOOP_ADDRESS_OFFSET as usize] as i32
    }
    ...
    {
        SoundFontMath::cents_to_hertz(self.gs[GeneratorType::INITIAL_FILTER_CUTOFF_FREQUENCY as usize] as f32)
    }
    ...
    {
        SoundFontMath::timecents_to_seconds(self.gs[GeneratorType::DELAY_MODULATION_LFO as usize] as f32)
    }

    pub fn get_frequency_modulation_lfo(&self) -> f32
    {
        SoundFontMath::cents_to_hertz(self.gs[GeneratorType::FREQUENCY_MODULATION_LFO as usize] as f32)
    }

    pub fn get_delay_vibrato_lfo(&self) -> f32
    {
        SoundFontMath::timecents_to_seconds(self.gs[GeneratorType::DELAY_VIBRATO_LFO as usize] as f32)
    }
    ...
    {
        SoundFontMath::timecents_to_seconds(self.gs[GeneratorType::DELAY_MODULATION_ENVELOPE as usize] as f32)
    }

    pub fn get_attack_modulation_envelope(&self) -> f32
    {
        SoundFontMath::timecents_to_seconds(self.gs[GeneratorType::ATTACK_MODULATION_ENVELOPE as usize] as f32)
    }

    pub fn get_hold_modulation_envelope(&self) -> f32
    {
        SoundFontMath::timecents_to_seconds(self.gs[GeneratorType::HOLD_MODULATION_ENVELOPE as usize] as f32)
    }

    pub fn get_decay_modulation_envelope(&self) -> f32
    {
        SoundFontMath::timecents_to_seconds(self.gs[GeneratorType::DECAY_MODULATION_ENVELOPE as usize] as f32)
    }
    ...
    {
        SoundFontMath::timecents_to_seconds(self.gs[GeneratorType::RELEASE_MODULATION_ENVELOPE as usize] as f32)
    }
    ...
    {
        SoundFontMath::timecents_to_seconds(self.gs[GeneratorType::DELAY_VOLUME_ENVELOPE as usize] as f32)
    }

    pub fn get_attack_volume_envelope(&self) -> f32
    {
        SoundFontMath::timecents_to_seconds(self.gs[GeneratorType::ATTACK_VOLUME_ENVELOPE as usize] as f32)
    }

    pub fn get_hold_volume_envelope(&self) -> f32
    {
        SoundFontMath::timecents_to_seconds(self.gs[GeneratorType::HOLD_VOLUME_ENVELOPE as usize] as f32)
    }

    pub fn get_decay_volume_envelope(&self) -> f32
    {
        SoundFontMath::timecents_to_seconds(self.gs[GeneratorType::DECAY_VOLUME_ENVELOPE as usize] as f32)
    }
    ...
    {
        SoundFontMath::timecents_to_seconds(self.gs[GeneratorType::RELEASE_VOLUME_ENVELOPE as usize] as f32)
    }
    ...
    {
        if self.gs[GeneratorType::SAMPLE_MODES as usize] != 2 { self.gs[GeneratorType::SAMPLE_MODES as usize] as i32 } else { LoopMode::NO_LOOP }
    }
    ...
    {
        if self.gs[GeneratorType::OVERRIDING_ROOT_KEY as usize] != -1 { self.gs[GeneratorType::OVERRIDING_ROOT_KEY as usize] as i32 } else { self.sample_original_pitch }
    }
}

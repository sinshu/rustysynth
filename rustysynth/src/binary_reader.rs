...
pub fn read_i16<R: io::Read>(reader: &mut R) -> Result<i16, io::Error>
{
...
pub fn read_u16<R: io::Read>(reader: &mut R) -> Result<u16, io::Error>
{
    let mut data: [u8; 2] = [0; 2];
    reader.read_exact(&mut data)?;
...
pub fn read_i32<R: io::Read>(reader: &mut R) -> Result<i32, io::Error>
{

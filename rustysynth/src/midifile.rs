...
impl Message
{
    ...
    {
        60000000.0 / (((self.command as i32) << 16) | ((self.data1 as i32) << 8) | (self.data2 as i32)) as f64
    }
}
...
impl MidiFile
{
    ...
    fn merge_tracks(message_lists: &Vec<Vec<Message>>, tick_lists: &Vec<Vec<i32>>, resolution: i32) -> (Vec<Message>, Vec<f64>)
    {
